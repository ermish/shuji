export const Frontmatterexample = () => { 
	 ShujiContext.date = '2021-01-01' 
	 ShujiContext.title = 'node with react and redux' 
	 ShujiContext.slug = 'node-react-redux' 
	 ShujiContext.description = 'How to node with react and redux' 
	 ShujiContext.tags = ['node','react','redux'] 
