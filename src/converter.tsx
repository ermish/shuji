...
interface FrontMatterAndJSX { frontMatterJsxString: string, jsxString: string }
interface FrontMatterSplitFromMarkdown { frontMatterJsxString: string, markdownString: string }
